...
<body>
    ...
    <div class="menu">
        <ul>
			...
			while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
				echo '<li><a class="" href="cmsDashboard.php.php">'.$row['ansattnavn'].'</a></li>';
			}
			
			?>
        	<li style="float:right;"><a  class="" style="color:#e04747;" href="index.php">Log Out</a></li>
    	</ul>
    </div>
    ...
    <div class="main">
        <div class="content">
			...
			if($numRows == 0){
				echo '<p style="text-align: center;">Du har ingen tomteområder enda!</p>';
			}else{
				while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
					echo '
						<div class="tomteomrade '.$row['omradenavn'].'">
							...
							<!-- Endreknapp -->
							<form method="post" class="endreKnapp">
								<input type="submit" value="ENDRE" name="endre" class="endreKnappKnapp">
							</form>
							<!-- INFO -->
							<div>
