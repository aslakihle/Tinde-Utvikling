			...
			<div id="tomteFinner">
				...
				<div id="tfFrame2" hidden>
					...
					<div class="tfBox">
						...
						<div id="tfOmradevalg">
							<ul>
								<li class="omrValg" id="tfomvalgVL">
									<span>VESTLANDET 
										<div>(5 områder)</div>
									</span>
								</li>
								<li class="omrValg" id="tfomvalgOL">
									<span>ØSTLANDET 
										<div>(6 områder)</div>
									</span>
								</li>
								<li class="omrValg" id="tfomvalgSL">
									<span>SØRLANDET
										<div>(7områder)</div>
									</span>
								</li>
								<li class="omrValg" id="tfomvalgMN">
									<span>MIDT-NORGE 
										<div>(0 områder)</div>
									</span>
								</li>
								<li class="omrValg" id="tfomvalgNN">
									<span>NORD-NORGE 
										<div>(0 områder)</div>
									</span>
								</li>
