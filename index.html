...
<g>
    ...
    <div class="header">
      <div class="banner"><img src="images/landscape.jpg"></div>
      <div id="logo"><img src="images/svg/tu-logo.svg"></div>
      <div id="headerknapper"><a href="">
          <div class="hButton b1"><u>HJEM</u></div></a><a href="../../tomteomrade.html">
          <div class="hButton">TOMTEOMRÅDER</div></a><a href="../../kontakt.html">
          <div class="hButton">KONTAKT</div></a></div>
      <div class="hytte1"><img src="images/svg/cabin.svg"></div>
      <div class="hytte2 hyttepos"><img src="images/svg/cabin.svg"></div>
      <div class="hytte3 hyttepos"><img src="images/svg/cabin.svg"></div>
    </div>
    <div class="main">
      <div class="content">
        <div id="tomteFinner">
          <div id="tfFrame1">
            <h1>Tomtefinner</h1>
            <div class="textBox2">Vi i Tinde vet at det finnes like mange tinder som det er mennesker. Derfor har Tinde utviklet en lang rekke omteområder, alle med hver sine særtrekk og egenskaper. Slik blir din hyttetomt spesielt for deg og dine – et sted der du kan dyrke de gode opplevelsene i livet.</div>
            <div class="tfImg">
              <div>BILDE SKAL HER ASS</div>
            </div>
            <div id="startTFbutton">
              <div class="tfButton">START</div>
            </div>
            <!--knapper-->
            <!--#buttons
            a(href="tomteomrade.html")
            	.button Se tomteområder
            a(href="kontakt.html")
            	.button Kontakt oss
            -->
          </div>
          <div id="tfFrame2" hidden>
            <h1>Finn din drømmetomt</h1>
            <div class="textBox2">Vi i Tinde vet at det finnes like mange tinder som det er mennesker. Derfor har Tinde utviklet en lang rekke omteområder, alle med hver sine særtrekk og egenskaper. Slik blir din hyttetomt spesielt for deg og dine – et sted der du kan dyrke de gode opplevelsene i livet.</div>
            <div class="tfBox">
              <div class="steps">Steg 1/3</div>
              <div class="tfText">Hvilke områder er du interessert i?</div>
              <div id="tfOmradevalg">
                <ul>
                  <li class="omrValg" id="tfomvalgVL"><span>VESTLANDET 
                      <div>(5 områder)</div></span></li>
                  <li class="omrValg" id="tfomvalgOL"><span>ØSTLANDET 
                      <div>(6 områder)</div></span></li>
                  <li class="omrValg" id="tfomvalgSL"><span>SØRLANDET
                      <div>(7områder)</div></span></li>
                  <li class="omrValg" id="tfomvalgMN"><span>MIDT-NORGE 
                      <div>(0 områder)</div></span></li>
                  <li class="omrValg" id="tfomvalgNN"><span>NORD-NORGE 
                      <div>(0 områder)</div></span></li>
                </ul>
              </div>
              <div id="tfOmradeKart">
              ...
              <div class="nextButtonPos" id="secondTFbutton">
                <div class="tfButton">NESTE</div>
              </div>
            </div>
          </div>
          <div id="tfFrame3" hidden>
            <h1>Tomtefinner</h1>
            <div class="textBox2">Vi i Tinde vet at det finnes like mange tinder som det er mennesker. Derfor har Tinde utviklet en lang rekke omteområder, alle med hver sine særtrekk og egenskaper. Slik blir din hyttetomt spesielt for deg og dine – et sted der du kan dyrke de gode opplevelsene i livet.</div>
            <div class="tfBox">
              <div class="steps">Steg 2/3</div>
              <div class="tfText">Hvilke fasiliteter bør tomten ha?</div>
              <div id="tfIconValg">
                <div>tilføy logoer her</div>
              </div>
              <!--#tfOmradeKart
              div kart her
              
              -->
              <div class="nextButtonPos" id="thirdTFbutton">
                <div class="tfButton">NESTE</div>
              </div>
            </div>
          </div>
          <div id="tfFrame4" hidden>
            <h1>Tomtefinner</h1>
            <div class="textBox2">Vi i Tinde vet at det finnes like mange tinder som det er mennesker. Derfor har Tinde utviklet en lang rekke omteområder, alle med hver sine særtrekk og egenskaper. Slik blir din hyttetomt spesielt for deg og dine – et sted der du kan dyrke de gode opplevelsene i livet.</div>
            <div class="tfBox">
              <div class="steps">Steg 3/3</div>
              <div class="tfText">Hvor mye bør tomten koste?</div>
              <div id="prisValg">
                <div class="prisText">Jeg vil bruke maks</div>
                <select class="dropdown" name="prisValg">
                  <option value="0">Minpris-Maxpris</option>
                  <option value="1">1kr-10kr</option>
                  <option value="2">100kr-200kr</option>
                </select>
              </div>
              <!--#tfOmradeKart
              div kart her
              ...
              -->
              <div class="nextButtonPos" id="fourthTFbutton">
                <div class="tfButton">NESTE</div>
              </div>
            </div>
          </div>
          <div id="tfFrame5" hidden>
            <h1>Tomtefinner</h1>
            <div class="textBox2">Vi i Tinde vet at det finnes like mange tinder som det er mennesker. Derfor har Tinde utviklet en lang rekke omteområder, alle med hver sine særtrekk og egenskaper. Slik blir din hyttetomt spesielt for deg og dine – et sted der du kan dyrke de gode opplevelsene i livet.</div>
            <div class="tfBox">
              <div class="steps">Resultat</div>
              <div class="tfText">Dette er tomteområdene du bør se på:</div>
              <div id="resultatTF">
                <ol>
                  <li>HJERKINHØ
                    <div>Treff på <span class="spanBlue">alle</span> søkekriterier.</div>
                  </li>
                  <li>HJERKINLIA
                    <div>Treff på <span class="spanBlue">alle</span> søkekriterier.</div>
                  </li>
                  <li>SOLLIA
                    <div>Treff på <span class="spanRed">noen</span> søkekriterier.</div>
                  </li>
                  <li>HÅFJELLET
                    <div>Treff på <span class="spanRed">noen</span> søkekriterier.</div>
                  </li>
              ...
              -->
              <div class="nextButtonPos" id="lastTFbutton">
                <div class="tfButton">NYTT SØK</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--søkefelt		-->
        <!--#sokBox
        h2 FINN DIN DRØMMETOMT
        .selectmeny
        	.fylke.selectDef 
        		span Fylke
        		br
        		select.dropdown(name="fylke")
        			option(value="0") Velg fylke
        			option(value="1") Olso
        			option(value="2") Hedemark
        	.tomteomrade.selectDef
        		span Tomteområde
        		br
        		select.dropdown(name="tomteomrade")
        			option(value="0") Velg tomteområde
        			option(value="1") 1
        			option(value="2") 2
        	.status.selectDef
        		span Status
        		br
        		select.dropdown(name="status")
        			option(value="0") Velg status
        			option(value="1") Solgt
        			option(value="2") Ikke solgt
        hr(style="width: 50%;")
        h3 Fasiliteter
        .valgMeny
        	section.valg(title="vann")
        		span Vann
        		.checkBox
        			input(type="checkbox" value="none" id="vann" name="check")
        			label(for="vann")
        	section.valg(title="Strom")
        		span Strøm
        		.checkBox
        			input(type="checkbox" value="none" id="strom" name="check")
        			label(for="strom")
        	section.valg(title="Bilvei")
        		span Bilvei
        		.checkBox
        			input(type="checkbox" value="none" id="bilvei" name="check")
        			label(for="bilvei")
        	br
        	br
        	section.valg(title="Ski")
        		span Ski
        		.checkBox
        			input(type="checkbox" value="none" id="ski" name="check")
        			label(for="ski")
        	section.valg(title="Turer")
        		span Turer
        		.checkBox
        			input(type="checkbox" value="none" id="turer" name="check")
        			label(for="turer")
        	section.valg(title="Bading")
        		span Bading
        		.checkBox
        			input(type="checkbox" value="none" id="bading" name="check")
        			label(for="bading")
        	section.valg(title="Jakt")
        		span Jakt
        		.checkBox
        			input(type="checkbox" value="none" id="jakt" name="check")
        			label(for="jakt") 
        	section.valg(title="fiske")
        		span Fiske
        		.checkBox2
        			input(type="checkbox" value="none" id="fiske" name="check")
        			label(for="fiske")
        input.sok(type="submit" value="Søk")
        
        -->
        <!--slider-->
        <!--.sliderWrap
        .prev
        	include images/svg/arrowLeft.svg
        
        .next
        	include images/svg/arrowRight.svg
        
        //BILDER HER MÅ HA AVLANGT UTSEENDE
        section.regular.slider
        	.slide
        		img(src="images/hytte.jpg")
        		.stedsNavn 
        			div JOTUMHEIMEN
        	.slide
        		img(src="images/hytte3.jpg")
        		.stedsNavn 
        			div SOLSLAK
        	.slide
        		img(src="images/hytte4.jpg")
        		.stedsNavn 
        			div GUNNVIKA
        	.slide
        		img(src="images/hytte5.jpg")
        		.stedsNavn 
        			div SNILSEFJELL
    ...
    <script type="text/javascript" src="js/forsideMenuHeader.js"></script>
